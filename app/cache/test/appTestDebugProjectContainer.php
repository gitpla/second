...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.twig.source_code_extension' => 'getApp_Twig_SourceCodeExtensionService',
            ...
            'security.user.provider.concrete.database_users' => 'getSecurity_User_Provider_Concrete_DatabaseUsersService',
    ...
    {
        return $this->services['app.controller_listener'] = new \AppBundle\EventListener\ControllerListener($this->get('app.twig.source_code_extension'));
    }
    ...
    {
        return $this->services['data_collector.dump'] = new \Symfony\Component\HttpKernel\DataCollector\DumpDataCollector($this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE), 'subl://open?url=file://%f&line=%l', 'UTF-8', NULL, NULL);
    }
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener('', $this->get('monolog.logger.php', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL, NULL, true, 'subl://open?url=file://%f&line=%l');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.controller', array(0 => 'app.controller_listener', 1 => 'registerCurrentController'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'npa4673_1000s', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[2].'/data/blog_test.sqlite'), 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3414490930fbf7ac6edb51099f8ff8ab356bc139a8b46d876183a22b8f40f129');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Utils\Markdown A AppBundle\Utils\Markdown instance.
     */
    protected function getMarkdownService()
    {
        return $this->services['markdown'] = new \AppBundle\Utils\Markdown();
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/test.log'), 200, true, NULL);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, 'homepage'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'security_logout'));
        ...
        $k->setOptions(array('login_path' => 'security_login_form', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $l->setOptions(array('login_path' => 'security_login_form', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $i, 'security_login_form', false);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.database_users')), 'secured_area', $a, $c), 2 => $j, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $i, 'secured_area', $k, $l, array('check_path' => 'security_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'secured_area', $m, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55ed9f4244c378.58698550', $a, $f), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $i, 'secured_area', $m, NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'slugger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Utils\Slugger A AppBundle\Utils\Slugger instance.
     */
    protected function getSluggerService()
    {
        return $this->services['slugger'] = new \AppBundle\Utils\Slugger();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\LocaleExtension('en|fr|de|es|cs|ru|uk|ro|pt_BR'));
        $instance->addExtension($this->get('app.twig.source_code_extension'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension('subl://open?url=file://%f&line=%l', $this->targetDirs[2], 'UTF-8'));
    ...
    /**
     * Gets the 'app.twig.source_code_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     *
     * @return \AppBundle\Twig\SourceCodeExtension A AppBundle\Twig\SourceCodeExtension instance.
     */
    protected function getApp_Twig_SourceCodeExtensionService()
    {
        return $this->services['app.twig.source_code_extension'] = new \AppBundle\Twig\SourceCodeExtension($this->get('twig.loader'), $this->targetDirs[2]);
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('secured_area', 'security_logout', 'logout', '_csrf_token', NULL);
    ...
    /**
     * Gets the 'security.user.provider.concrete.database_users' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_DatabaseUsersService()
    {
        return $this->services['security.user.provider.concrete.database_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:User', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_path' => ($this->targetDirs[2].'/data/blog.sqlite'),
