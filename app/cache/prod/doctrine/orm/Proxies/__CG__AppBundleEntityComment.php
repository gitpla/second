...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'post', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'authorEmail', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'publishedAt');
        }
